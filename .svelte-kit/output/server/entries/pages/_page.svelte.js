...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		*/
		...
		$$renderer.push(`<div class="space-y-6"><div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4"><h2 class="text-2xl font-bold">Gallery</h2> <button class="btn btn-ghost btn-sm">Refresh</button></div> <div class="collapse collapse-arrow bg-base-100 border border-base-300"><input type="checkbox"/> <div class="collapse-title font-medium">Upload Image</div> <div class="collapse-content">`);
		$$renderer.push("<!--[0-->");
